...
public class CarMasterEntityRealmProxy extends magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity
    implements RealmObjectProxy, CarMasterEntityRealmProxyInterface {

    static final class CarMasterEntityColumnInfo extends ColumnInfo {
        long Make_IDIndex;
        long Make_NameIndex;
        long Model_IDIndex;
        ...
        CarMasterEntityColumnInfo(OsSchemaInfo schemaInfo) {
            super(20);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("CarMasterEntity");
        ...
        CarMasterEntityColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new CarMasterEntityColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final CarMasterEntityColumnInfo src = (CarMasterEntityColumnInfo) rawSrc;
            final CarMasterEntityColumnInfo dst = (CarMasterEntityColumnInfo) rawDst;
    ...
    private CarMasterEntityColumnInfo columnInfo;
    private ProxyState<magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity> proxyState;

    CarMasterEntityRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (CarMasterEntityColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("CarMasterEntity", 20, 0);
    ...
    public static CarMasterEntityColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new CarMasterEntityColumnInfo(schemaInfo);
    }
    ...
    @SuppressWarnings("cast")
    public static magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity obj = null;
        if (update) {
            Table table = realm.getTable(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class);
            CarMasterEntityColumnInfo columnInfo = (CarMasterEntityColumnInfo) realm.getSchema().getColumnInfo(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class), false, Collections.<String> emptyList());
                    obj = new io.realm.CarMasterEntityRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("Variant_ID")) {
                if (json.isNull("Variant_ID")) {
                    obj = (io.realm.CarMasterEntityRealmProxy) realm.createObjectInternal(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.CarMasterEntityRealmProxy) realm.createObjectInternal(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class, json.getString("Variant_ID"), true, excludeFields);
                }
            } else {
        ...
        final CarMasterEntityRealmProxyInterface objProxy = (CarMasterEntityRealmProxyInterface) obj;
        if (json.has("Make_ID")) {
    ...
    public static magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity obj = new magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity();
        final CarMasterEntityRealmProxyInterface objProxy = (CarMasterEntityRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity copyOrUpdate(Realm realm, magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity) cachedRealmObject;
        }

        magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class);
            CarMasterEntityColumnInfo columnInfo = (CarMasterEntityColumnInfo) realm.getSchema().getColumnInfo(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class);
            long pkColumnIndex = columnInfo.Variant_IDIndex;
            String value = ((CarMasterEntityRealmProxyInterface) object).realmGet$Variant_ID();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.CarMasterEntityRealmProxy();
    ...
    public static magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity copy(Realm realm, magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity realmObject = realm.createObjectInternal(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class, ((CarMasterEntityRealmProxyInterface) newObject).realmGet$Variant_ID(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        CarMasterEntityRealmProxyInterface realmObjectSource = (CarMasterEntityRealmProxyInterface) newObject;
        CarMasterEntityRealmProxyInterface realmObjectCopy = (CarMasterEntityRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity object, Map<RealmModel,Long> cache) {
        ...
        CarMasterEntityColumnInfo columnInfo = (CarMasterEntityColumnInfo) realm.getSchema().getColumnInfo(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class);
        long pkColumnIndex = columnInfo.Variant_IDIndex;
        String primaryKeyValue = ((CarMasterEntityRealmProxyInterface) object).realmGet$Variant_ID();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$Make_ID = ((CarMasterEntityRealmProxyInterface) object).realmGet$Make_ID();
        if (realmGet$Make_ID != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.Make_IDIndex, rowIndex, realmGet$Make_ID, false);
        }
        String realmGet$Make_Name = ((CarMasterEntityRealmProxyInterface) object).realmGet$Make_Name();
        ...
        String realmGet$Model_ID = ((CarMasterEntityRealmProxyInterface) object).realmGet$Model_ID();
        if (realmGet$Model_ID != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.Model_IDIndex, rowIndex, realmGet$Model_ID, false);
        }
        String realmGet$Model_Name = ((CarMasterEntityRealmProxyInterface) object).realmGet$Model_Name();
        ...
        String realmGet$Variant_Name = ((CarMasterEntityRealmProxyInterface) object).realmGet$Variant_Name();
        ...
        String realmGet$Model_ID1 = ((CarMasterEntityRealmProxyInterface) object).realmGet$Model_ID1();
        ...
        String realmGet$Cubic_Capacity = ((CarMasterEntityRealmProxyInterface) object).realmGet$Cubic_Capacity();
        ...
        String realmGet$Fuel_ID = ((CarMasterEntityRealmProxyInterface) object).realmGet$Fuel_ID();
        if (realmGet$Fuel_ID != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.Fuel_IDIndex, rowIndex, realmGet$Fuel_ID, false);
        }
        String realmGet$Seating_Capacity = ((CarMasterEntityRealmProxyInterface) object).realmGet$Seating_Capacity();
        ...
        String realmGet$ExShoroomPrice = ((CarMasterEntityRealmProxyInterface) object).realmGet$ExShoroomPrice();
        ...
        String realmGet$IsActive = ((CarMasterEntityRealmProxyInterface) object).realmGet$IsActive();
        if (realmGet$IsActive != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.IsActiveIndex, rowIndex, realmGet$IsActive, false);
        }
        String realmGet$CreatedOn = ((CarMasterEntityRealmProxyInterface) object).realmGet$CreatedOn();
        if (realmGet$CreatedOn != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.CreatedOnIndex, rowIndex, realmGet$CreatedOn, false);
        }
        String realmGet$ModifyOn = ((CarMasterEntityRealmProxyInterface) object).realmGet$ModifyOn();
        if (realmGet$ModifyOn != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.ModifyOnIndex, rowIndex, realmGet$ModifyOn, false);
        }
        String realmGet$Product_Id_New = ((CarMasterEntityRealmProxyInterface) object).realmGet$Product_Id_New();
        ...
        String realmGet$Make_Name1 = ((CarMasterEntityRealmProxyInterface) object).realmGet$Make_Name1();
        ...
        String realmGet$Model_Name1 = ((CarMasterEntityRealmProxyInterface) object).realmGet$Model_Name1();
        ...
        String realmGet$Fuel_Name = ((CarMasterEntityRealmProxyInterface) object).realmGet$Fuel_Name();
        ...
        String realmGet$Description = ((CarMasterEntityRealmProxyInterface) object).realmGet$Description();
        if (realmGet$Description != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.DescriptionIndex, rowIndex, realmGet$Description, false);
        }
        String realmGet$Make_ID1 = ((CarMasterEntityRealmProxyInterface) object).realmGet$Make_ID1();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        CarMasterEntityColumnInfo columnInfo = (CarMasterEntityColumnInfo) realm.getSchema().getColumnInfo(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class);
        long pkColumnIndex = columnInfo.Variant_IDIndex;
        magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity object = null;
        while (objects.hasNext()) {
            object = (magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity.class);
    ...
    public static magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity createDetachedCopy(magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity) cachedObject.object;
            }
            unmanagedObject = (magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        CarMasterEntityRealmProxyInterface unmanagedCopy = (CarMasterEntityRealmProxyInterface) unmanagedObject;
        CarMasterEntityRealmProxyInterface realmSource = (CarMasterEntityRealmProxyInterface) realmObject;
    ...
    static magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity update(Realm realm, magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity realmObject, magicfinmart.datacomp.com.finmartserviceapi.finmart.model.CarMasterEntity newObject, Map<RealmModel, RealmObjectProxy> cache) {
        CarMasterEntityRealmProxyInterface realmObjectTarget = (CarMasterEntityRealmProxyInterface) realmObject;
        CarMasterEntityRealmProxyInterface realmObjectSource = (CarMasterEntityRealmProxyInterface) newObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("CarMasterEntity = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        CarMasterEntityRealmProxy aCarMasterEntity = (CarMasterEntityRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aCarMasterEntity.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aCarMasterEntity.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aCarMasterEntity.proxyState.getRow$realm().getIndex()) return false;
