...
public class HealthPackDEntity {
    /**
    ...
    private List<LstPackageDetailsEntity> lstPackageDetails;
    ...
    public void setLstPackageDetails(List<LstPackageDetailsEntity> lstPackageDetails) {
