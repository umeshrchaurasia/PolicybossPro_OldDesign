...
public final class FragmentUltraLakshayUnmatchedBenefitBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentUltraLakshayUnmatchedBenefitBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull TextView txtHdr, @NonNull TextView txtLumpsumAmnt,
      @NonNull TextView txtMaturityAfterYearAmnt, @NonNull TextView txtMaturityAfterYearText,
      @NonNull TextView txtMonthlyforYearAmnt, @NonNull TextView txtMonthlyforYearText,
      @NonNull TextView txtOnMaturityDateAmnt, @NonNull TextView txtPremTerm) {
  ...
  @NonNull
  public static FragmentUltraLakshayUnmatchedBenefitBinding inflate(
  ...
  public static FragmentUltraLakshayUnmatchedBenefitBinding inflate(
    ...
    View root = inflater.inflate(R.layout.fragment_ultra_lakshay_unmatched_benefit, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentUltraLakshayUnmatchedBenefitBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentUltraLakshayUnmatchedBenefitBinding((LinearLayout) rootView,
          txtAnnualEndOfTermAmnt, txtAnnualPrem1yearAmnt, txtAnnualPrem2to7Amnt,
          txtAnnualPrem2to7Text, txtHdr, txtLumpsumAmnt, txtMaturityAfterYearAmnt,
          txtMaturityAfterYearText, txtMonthlyforYearAmnt, txtMonthlyforYearText,
