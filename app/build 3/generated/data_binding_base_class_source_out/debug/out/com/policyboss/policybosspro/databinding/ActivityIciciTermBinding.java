...
public final class ActivityIciciTermBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityIciciTermBinding(@NonNull RelativeLayout rootView, @NonNull AppBarLayout appBar,
      @NonNull RelativeLayout bottmc, @NonNull BottomNavigationView bottomNavigation,
      @NonNull FrameLayout frameLayout, @NonNull ImageView ivHdrInput,
      @NonNull ImageView ivHdrQuote, @NonNull LinearLayout lyheader, @NonNull Toolbar toolbar,
  ...
  @NonNull
  public static ActivityIciciTermBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityIciciTermBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_icici_term, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityIciciTermBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityIciciTermBinding((RelativeLayout) rootView, appBar, bottmc,
