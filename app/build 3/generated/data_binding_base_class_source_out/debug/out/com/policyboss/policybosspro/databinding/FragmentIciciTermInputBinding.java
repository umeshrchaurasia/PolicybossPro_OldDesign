...
public final class FragmentIciciTermInputBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final Spinner spICICIPremiumPayment;
  ...
  @NonNull
  public final TextInputLayout tilPremiumPayment;
  ...
  private FragmentIciciTermInputBinding(@NonNull LinearLayout rootView, @NonNull Button btnGetQuote,
      ...
      @NonNull EditText etPincode, @NonNull ImageView imgInsurerLogo, @NonNull ImageView ivBuy,
      @NonNull ImageView ivEdit, @NonNull ImageView ivInfo, @NonNull ImageView ivPdf,
      @NonNull ContentTermHeaderBinding layoutCompare, @NonNull LinearLayout llAccidental,
      @NonNull LinearLayout llAddon, @NonNull LinearLayout llCritical,
      @NonNull LinearLayout llICICILumpSumpPerc, @NonNull ScrollView mainScroll,
      ...
      @NonNull Spinner spICICIPremiumPayment, @NonNull Spinner spICICIPremiumTerm,
      @NonNull TextInputLayout tilPincode, @NonNull TextInputLayout tilPremiumPayment,
      @NonNull TextView tvAge, @NonNull TextView tvCrn, @NonNull TextView tvGender,
      @NonNull TextView tvPolicyTerm, @NonNull TextView tvSmoker, @NonNull TextView tvSum,
    ...
    this.spICICIPremiumPayment = spICICIPremiumPayment;
    this.spICICIPremiumTerm = spICICIPremiumTerm;
    this.tilPincode = tilPincode;
    this.tilPremiumPayment = tilPremiumPayment;
    this.tvAge = tvAge;
    this.tvCrn = tvCrn;
  ...
  @NonNull
  public static FragmentIciciTermInputBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentIciciTermInputBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_icici_term_input, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentIciciTermInputBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.spICICIPremiumPayment;
      Spinner spICICIPremiumPayment = rootView.findViewById(id);
      if (spICICIPremiumPayment == null) {
        break missingId;
      }
      ...
      id = R.id.tilPremiumPayment;
      TextInputLayout tilPremiumPayment = rootView.findViewById(id);
      if (tilPremiumPayment == null) {
        break missingId;
      }
      ...
      return new FragmentIciciTermInputBinding((LinearLayout) rootView, btnGetQuote, cvInputDetails,
          cvQuoteDetails, etICICIAccidentalBenefits, etICICICriticalIllness, etICICILumpSumpPerc,
          etICICIPolicyTerm, etICICIPremiumTerm, etICICISumAssured, etPincode, imgInsurerLogo,
          ivBuy, ivEdit, ivInfo, ivPdf, binding_layoutCompare, llAccidental, llAddon, llCritical,
          llICICILumpSumpPerc, mainScroll, minusICICIAcc, minusICICICritical,
          minusICICILumpSumpPerc, minusICICIPTerm, minusICICIPreTerm, minusICICISum, plusICICIAcc,
          plusICICICritical, plusICICILumpSumpPerc, plusICICIPTerm, plusICICIPreTerm, plusICICISum,
          rvAddOn, spICICIOptions, spICICIPremiumFrequency, spICICIPremiumPayment,
          spICICIPremiumTerm, tilPincode, tilPremiumPayment, tvAge, tvCrn, tvGender, tvPolicyTerm,
          tvSmoker, tvSum, txtAge, txtCover, txtFinalPremium, txtICICIIncreasingIncome,
          txtICICILumpSum, txtICICILumpSumRegular, txtICICIRegularIncome, txtPlanNAme,
          txtPolicyTerm);
    }
