...
public final class ContentRazorPaymentBinding implements ViewBinding {
  @NonNull
  ...
  private ContentRazorPaymentBinding(@NonNull LinearLayout rootView, @NonNull Button btnBuy,
  ...
  @NonNull
  public static ContentRazorPaymentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ContentRazorPaymentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.content_razor_payment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ContentRazorPaymentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ContentRazorPaymentBinding((LinearLayout) rootView, btnBuy, btnCancel, btnContinue,
          btnHomeContinue, cvBuy, cvFailure, cvSuccess, lblPayable, lblcustomername, lblfailcustid,
          lblname, lblpaymentstatus, txtCustomerName, txtDisplayAmount, txtFailureMessage,
          txtProdName, txtSuccessMessage, txtSuccessTitle, txtfailcustid, txtpaymentstatus,
          txtprdName);
    }
