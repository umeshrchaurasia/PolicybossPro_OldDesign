...
public final class LayoutPropertyInfoLapBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutPropertyInfoLapBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutPropertyInfoLapBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutPropertyInfoLapBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_property_info_lap, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutPropertyInfoLapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutPropertyInfoLapBinding((LinearLayout) rootView, acCity, etContact,
          etCostOfProp, etTenureInYear, rbForcons, rbOther, rbReady, rbResale, rbSearching, rbUnder,
          rgProperty1, rgProperty2, sbTenure, txtApplicantDetail, txtDispalayMaxTenureYear,
