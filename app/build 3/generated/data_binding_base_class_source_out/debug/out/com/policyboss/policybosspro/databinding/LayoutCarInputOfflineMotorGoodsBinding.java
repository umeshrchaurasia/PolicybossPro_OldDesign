...
public final class LayoutCarInputOfflineMotorGoodsBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutCarInputOfflineMotorGoodsBinding(@NonNull ScrollView rootView,
      ...
      @NonNull EditText etGross, @NonNull EditText etMfgDate, @NonNull EditText etMobile,
      @NonNull EditText etRegDate, @NonNull EditText etUsage, @NonNull EditText etfbaSearch,
  ...
  @NonNull
  public static LayoutCarInputOfflineMotorGoodsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutCarInputOfflineMotorGoodsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_car_input_offline_motor_goods, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutCarInputOfflineMotorGoodsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.etGross;
      EditText etGross = rootView.findViewById(id);
      if (etGross == null) {
        break missingId;
      }
      ...
      return new LayoutCarInputOfflineMotorGoodsBinding((ScrollView) rootView, acMakeModelEdit,
          acRto, cvNcb, etCC, etComment, etCustomerName, etExpDate, etExtValue, etGross, etMfgDate,
          etMobile, etRegDate, etUsage, etfbaSearch, llNoClaim, llVerifyCarDetails, llfbaSearch,
          sbNoClaimBonus, spFuelEdit, spInsSubTYpe, spMonth, spNcbPercent, spPrevIns, spVarientEdit,
          spYear, swIndividual, switchNcb, tilExt, tvCarNo, tvClaimNo, tvClaimYes, tvProgress);
    }
