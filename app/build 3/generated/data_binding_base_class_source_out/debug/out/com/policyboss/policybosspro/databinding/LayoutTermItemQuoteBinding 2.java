...
public final class LayoutTermItemQuoteBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutTermItemQuoteBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout llDetails, @NonNull TextView txtCustRefNo,
      @NonNull ImageView txtOverflowMenu, @NonNull TextView txtPersonName,
      @NonNull TextView txtQuoteDate, @NonNull TextView txtVehicleName) {
  ...
  @NonNull
  public static LayoutTermItemQuoteBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutTermItemQuoteBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_term_item_quote, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutTermItemQuoteBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutTermItemQuoteBinding((LinearLayout) rootView, llDetails, txtCustRefNo,
