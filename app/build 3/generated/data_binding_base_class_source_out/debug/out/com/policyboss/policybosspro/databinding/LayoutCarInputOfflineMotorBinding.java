...
public final class LayoutCarInputOfflineMotorBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final EditText etIDVAmount;
  ...
  private LayoutCarInputOfflineMotorBinding(@NonNull ScrollView rootView,
      ...
      @NonNull EditText etIDVAmount, @NonNull EditText etMfgDate, @NonNull EditText etMobile,
      @NonNull EditText etRegDate, @NonNull EditText etfbaSearch, @NonNull LinearLayout llNoClaim,
      ...
      @NonNull Switch swIndividual, @NonNull Switch switchNcb, @NonNull TextInputLayout tilExt,
      @NonNull EditText tvCarNo, @NonNull TextView tvClaimNo, @NonNull TextView tvClaimYes,
  ...
  @NonNull
  public static LayoutCarInputOfflineMotorBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutCarInputOfflineMotorBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_car_input_offline_motor, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutCarInputOfflineMotorBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.etIDVAmount;
      EditText etIDVAmount = rootView.findViewById(id);
      if (etIDVAmount == null) {
        break missingId;
      }
      ...
      return new LayoutCarInputOfflineMotorBinding((ScrollView) rootView, acMakeModel, acRto, cvNcb,
          etCC, etComment, etCustomerName, etExpDate, etExtValue, etIDVAmount, etMfgDate, etMobile,
          etRegDate, etfbaSearch, llNoClaim, llVerifyCarDetails, llfbaSearch, sbNoClaimBonus,
          spFuel, spInsSubTYpe, spMonth, spNcbPercent, spPrevIns, spVarient, spYear, swIndividual,
          switchNcb, tilExt, tvCarNo, tvClaimNo, tvClaimYes, tvProgress);
    }
