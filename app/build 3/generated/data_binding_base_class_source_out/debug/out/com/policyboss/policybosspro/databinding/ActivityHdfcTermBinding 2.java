...
public final class ActivityHdfcTermBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityHdfcTermBinding(@NonNull RelativeLayout rootView, @NonNull AppBarLayout appBar,
  ...
  @NonNull
  public static ActivityHdfcTermBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityHdfcTermBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_hdfc_term, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityHdfcTermBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHdfcTermBinding((RelativeLayout) rootView, appBar, bottmc,
