...
public final class ActivityInputQuoteBottmBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityInputQuoteBottmBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityInputQuoteBottmBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityInputQuoteBottmBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_input_quote_bottm, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityInputQuoteBottmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityInputQuoteBottmBinding((RelativeLayout) rootView, appBar, bottmc,
