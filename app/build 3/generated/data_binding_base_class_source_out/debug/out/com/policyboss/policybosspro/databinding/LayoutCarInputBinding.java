...
public final class LayoutCarInputBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView txtExistingPolicyNo;

  @NonNull
  public final TextView txtExistingPolicyYes;

  private LayoutCarInputBinding(@NonNull ScrollView rootView,
      ...
      @NonNull LinearLayout llExistingPolicy, @NonNull LinearLayout llExp,
      ...
      @NonNull Spinner spFuel, @NonNull Spinner spInsSubTYpe, @NonNull Spinner spMonth,
      @NonNull Spinner spNcbPercent, @NonNull Spinner spPrevIns, @NonNull Spinner spVarient,
      @NonNull Spinner spYear, @NonNull Switch swIndividual, @NonNull Switch switchNcb,
      @NonNull TextInputLayout tilExt, @NonNull TextView tvCarNo, @NonNull TextView tvClaimNo,
      @NonNull TextView tvClaimYes, @NonNull TextView tvProgress,
      @NonNull TextView txtExistingPolicyNo, @NonNull TextView txtExistingPolicyYes) {
    ...
    this.llExistingPolicy = llExistingPolicy;
    this.llExp = llExp;
    ...
    this.txtExistingPolicyNo = txtExistingPolicyNo;
    this.txtExistingPolicyYes = txtExistingPolicyYes;
  }
  ...
  @NonNull
  public static LayoutCarInputBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutCarInputBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_car_input, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutCarInputBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.llExistingPolicy;
      LinearLayout llExistingPolicy = rootView.findViewById(id);
      if (llExistingPolicy == null) {
        break missingId;
      }

      id = R.id.llExp;
      LinearLayout llExp = rootView.findViewById(id);
      if (llExp == null) {
        break missingId;
      }
      ...
      id = R.id.txtExistingPolicyNo;
      TextView txtExistingPolicyNo = rootView.findViewById(id);
      if (txtExistingPolicyNo == null) {
        break missingId;
      }

      id = R.id.txtExistingPolicyYes;
      TextView txtExistingPolicyYes = rootView.findViewById(id);
      if (txtExistingPolicyYes == null) {
        break missingId;
      }

      return new LayoutCarInputBinding((ScrollView) rootView, acMakeModel, acRto, cvNcb, etCC,
          etCustomerName, etExpDate, etExtValue, etMfgDate, etMobile, etRegDate, etfbaSearch,
          llExistingPolicy, llExp, llNoClaim, llVerifyCarDetails, llfbaSearch, sbNoClaimBonus,
          spFuel, spInsSubTYpe, spMonth, spNcbPercent, spPrevIns, spVarient, spYear, swIndividual,
          switchNcb, tilExt, tvCarNo, tvClaimNo, tvClaimYes, tvProgress, txtExistingPolicyNo,
          txtExistingPolicyYes);
    }
