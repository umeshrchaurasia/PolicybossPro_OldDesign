...
/**
 * Created by IN-RB on 14-03-2018.
 */

public class CompareIns_ApplicationAdapter extends RecyclerView.Adapter<CompareIns_ApplicationAdapter.ApplicationItem>implements Filterable {

    Fragment fragment;
    List<FmPersonalLoanRequest> mAppList;
    List<FmPersonalLoanRequest> mAppListFiltered;

    public CompareIns_ApplicationAdapter(List<FmPersonalLoanRequest> mAppList, List<FmPersonalLoanRequest> mAppListFiltered) {
        this.mAppList = mAppList;
        this.mAppListFiltered = mAppListFiltered;
    }
    ...
    public ApplicationItem onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CompareIns_ApplicationAdapter.ApplicationItem(itemView);
    }

    @Override
    public void onBindViewHolder(ApplicationItem holder, int position) {
        if (holder instanceof CompareIns_ApplicationAdapter.ApplicationItem) {
