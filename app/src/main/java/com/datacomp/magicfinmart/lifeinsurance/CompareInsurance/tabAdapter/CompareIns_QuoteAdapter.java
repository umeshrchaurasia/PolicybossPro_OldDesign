package com.datacomp.magicfinmart.lifeinsurance.CompareInsurance.tabAdapter;
...
/**
 * Created by IN-RB on 13-03-2018.
 */

public class CompareIns_QuoteAdapter extends RecyclerView.Adapter<CompareIns_QuoteAdapter.QuoteItem> implements View.OnClickListener,Filterable {

    Fragment mFrament;
    List<FmPersonalLoanRequest> mQuoteList;
    List<FmPersonalLoanRequest> mQuoteListFiltered;

    public CompareIns_QuoteAdapter(Fragment mFrament,List<FmPersonalLoanRequest> list) {
    ...
    @Override
    public CompareIns_QuoteAdapter.QuoteItem onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_item_quote_loan, parent, false);
        return new CompareIns_QuoteAdapter.QuoteItem(itemView);
    }

    @Override
    public void onBindViewHolder(CompareIns_QuoteAdapter.QuoteItem holder, int position) {


        if (holder instanceof CompareIns_QuoteAdapter.QuoteItem) {
