...
public class ActivityTabsPagerAdapter_Compare extends FragmentStatePagerAdapter {
    ...
    public ActivityTabsPagerAdapter_Compare(FragmentManager fm ,PersonalMainEntity masterData) {
        super(fm);
