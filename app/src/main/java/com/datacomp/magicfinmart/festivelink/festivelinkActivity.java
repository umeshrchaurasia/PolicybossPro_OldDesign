...
public class festivelinkActivity extends BaseActivity implements IResponseSubcriber {
    ...
    List<festivelinkEntity> listShareMessag;
    DBPersistanceController dbPersistanceController;
    LoginResponseEntity loginResponseEntity;
    festivelinkResponse getfestivelinkResponse;
    ...
    public void OnSuccess(APIResponse response, String message) {
        cancelDialog();
        if (response instanceof festivelinkResponse) {

            getfestivelinkResponse = ((festivelinkResponse) response);
