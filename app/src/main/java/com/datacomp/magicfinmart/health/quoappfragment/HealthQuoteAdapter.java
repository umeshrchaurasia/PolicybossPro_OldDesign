...
public class HealthQuoteAdapter extends RecyclerView.Adapter<HealthQuoteAdapter.QuoteItem> {
    Fragment mFrament;
    List<QuoteListEntity> mQuoteList;
    SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");

    public HealthQuoteAdapter(Fragment context, List<QuoteListEntity> list) {
