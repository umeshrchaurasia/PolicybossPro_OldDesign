...
//            setApplicantDetails();
//            showDialog();
//            new HomeLoanController(LAP_LoanActivity.this).getHomeLoan(homeLoanRequest, this);
//
//        }
//
//
...
//
//        salaryTypeAdapter = new ArrayAdapter<String>(LAP_LoanActivity.this,
...
//        coApp_relationTypeAdapter = new ArrayAdapter<String>(LAP_LoanActivity.this,
...
//        coApp_salaryTypeAdapter = new ArrayAdapter<String>(LAP_LoanActivity.this,
//                android.R.layout.simple_spinner_item, getResources().getStringArray(R.array.IncomeSource));
...
//
//        homeLoanRequest.setPropertyID("" +  new DBPersistanceController(LAP_LoanActivity.this).getPropertyId(spNewLoan.getSelectedItem().toString()));
...
//                startActivity(new Intent(LAP_LoanActivity.this, LapLoanQuoteActivity.class).putParcelableArrayListExtra(Constants.QUOTES, (ArrayList<QuoteEntity>) getQuoteResponse.getData())
//                        .putExtra(Constants.QUOTES, getQuoteResponse)
//                        .putExtra(Constants.LAP_REQUEST, homeLoanRequest));
//            } else {
//                Toast.makeText(LAP_LoanActivity.this, response.getMsg(), Toast.LENGTH_SHORT).show();
//            }
//        }
//    }
//
...
//        Toast.makeText(LAP_LoanActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
//    }
//
