...
public class HomeLoanApplicationAdapter extends RecyclerView.Adapter<HomeLoanApplicationAdapter.ApplicationItem>{

    Context context;
    public HomeLoanApplicationAdapter(Context context) {
