...
import com.datacomp.magicfinmart.offline_quotes.OfflineQuoteForm.Offline_Term.TermQuoteListFragment_offline;
...
public class Goods_ActivityTabsPagerAdapter extends FragmentStatePagerAdapter {
  ...
  //  public final static String TERM_APPLICATION_LIST = "TERM_LIST_APPLICATION";
    ...
    public Goods_ActivityTabsPagerAdapter(FragmentManager fm, TermQuoteApplicationResponse masterData) {
        super(fm);
