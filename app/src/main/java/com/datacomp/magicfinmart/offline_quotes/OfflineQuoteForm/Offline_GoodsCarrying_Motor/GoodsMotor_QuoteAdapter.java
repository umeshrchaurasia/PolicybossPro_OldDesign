...
public class GoodsMotor_QuoteAdapter extends RecyclerView.Adapter<GoodsMotor_QuoteAdapter.QuoteItem> implements View.OnClickListener, Filterable {
    Fragment mFrament;
    List<TermFinmartRequest> mQuoteList;
    List<TermFinmartRequest> mQuoteListFiltered;
    SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");

    public GoodsMotor_QuoteAdapter(Fragment context, List<TermFinmartRequest> list) {
    ...
    public QuoteItem onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new GoodsMotor_QuoteAdapter.QuoteItem(itemView);
